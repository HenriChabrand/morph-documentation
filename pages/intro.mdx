...
<Tabs items={["HubSpot", "Salesforce", "Intercom"]}>
  <Tabs.Tab>
    <Screenshot
      src="/assets/docs/card-extension-hubspot.png"
      alt="HubSpot Card"
    />
  </Tabs.Tab>
  <Tabs.Tab>
    <Screenshot
      src="/assets/docs/card-extension-salesforce.png"
      alt="Salesforce Card"
    />
  </Tabs.Tab>
  <Tabs.Tab>
    <Screenshot
      src="/assets/docs/card-extension-intercom.png"
      alt="Intercom Card"
    />
  </Tabs.Tab>
</Tabs>
...
<Callout>Don't forget to set your API key in the environment variable.</Callout>
### Test with Postman
